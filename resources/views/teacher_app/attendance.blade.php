...
اختر القائمة المعنية لغرض ادخال الغيابات
      ...
      <script>
        ...
        {   
            $.ajax({
               type:'GET',
               url:'/ajax/Teacherapp/getstudy/' + year,
               success: function(response){
                            $("#studydiv").show();
                            $("#stagediv").hide();
                            $("#branchdiv").hide();
        ...
        function getstage(study)
        {
            ...
            $.ajax({
               type:'GET',
               url:'/ajax/Teacherapp/getstage/' + year + '/' + study,
               success: function(response){
                            $("#stagediv").show();
                            $("#branchdiv").hide();
                            $("#subjectdiv").hide();
        ...
        function getbranch(stage)
        {
            ...
            $.ajax({
               type:'GET',
               url:'/ajax/Teacherapp/getbranch/' + year + '/' + study+ '/' + stage,
               success: function(response){
                            $("#branchdiv").show();
                            $("#subjectdiv").hide();
                            $("#datediv").hide();
        ...
        function getsubject(branch)
        {
            ...
            $.ajax({
               type:'GET',
               url:'/ajax/Teacherapp/getsubject/' + year + '/' + study+ '/' + stage+ '/' + branch + '/' + teacher,
               success: function(response){
                            $("#subjectdiv").show();
                            $("#datediv").hide();
                            $("#submitdiv").hide();
        ...
        function is_duplicated()
        {
            ...
            $.ajax({
               type:'GET',
               url:'/ajax/Teacherapp/is_duplicated/' + subject_selected + '/' + year + '/' + month + '/' + day + '/' + years + '/' +study+ '/' +stage+ '/' +branch,
               success: function(response){
...
<div class="card border-dark">
    ...
    <div class="card-body">
    <form action="{{route('teacher_app_attendance.record')}}" method="GET">
